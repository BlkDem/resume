<template>
  ...
  >
    ...
    <!-- <div class="m-4"> -->
      ...
      <div class="p-gradient my-2"><p class="small-p">2020-05 - по настоящее время</p></div>
      ...
      <p><a href="https://www.suek.ru" target="_blank" class="gold">АО «СУЭК»</a> - поддержка инфраструктуры, servicedesk</p>
